...
Corepack is an experimental tool that helps you to manage your package managers. It ships with Node.js core so you probably already have it installed today.
...
While these features seem very similar, they have very different implementations. Specifically, "reproducible installs" is only guaranteed when you use the same package manager that knows how to read a given lockfile, such as:
...
[Corepack](https://nodejs.org/api/corepack.html) is an experimental tool that helps you to manage your package managers. Although you've [probably never heard of it](https://twitter.com/styfle/status/1526600519686438917), Corepack ships with Node.js core. So you probably already have it installed!

Corepack transparently installs the correct package manager based on the closest `package.json` file, meaning you can use pnpm 6 with one project and pnpm 7 with another project, no need to run additional commands.

## How do I use Corepack?

To get started, make sure you are using Node.js 4.19.0 or newer.
