...
The code utilizes the App Router, introduced in [Next.js 13](https://nextjs.org/blog/next-13), to query GitHub's API at build time and dynamically generate static pages for each of my GitHub repos as well as each of my Blog posts.
